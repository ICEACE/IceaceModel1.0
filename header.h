...
/** \def START_FIRM_BANK_INIT_LOANS_MESSAGE_LOOP
 * \brief Start of loop to process firm_bank_init_loans messages. */
...
/** \def FINISH_FIRM_BANK_INIT_LOANS_MESSAGE_LOOP
 * \brief Finish of loop to process firm_bank_init_loans messages. */
#define FINISH_FIRM_BANK_INIT_LOANS_MESSAGE_LOOP }
/** \def START_FIRM_BANK_INIT_DEPOSIT_MESSAGE_LOOP
 * \brief Start of loop to process firm_bank_init_deposit messages. */
...
/** \def FINISH_FIRM_BANK_INIT_DEPOSIT_MESSAGE_LOOP
 * \brief Finish of loop to process firm_bank_init_deposit messages. */
...
/** \def START_HOUSEHOLD_BANK_INIT_MORTGAGES_MESSAGE_LOOP
 * \brief Start of loop to process household_bank_init_mortgages messages. */
...
/** \def FINISH_HOUSEHOLD_BANK_INIT_MORTGAGES_MESSAGE_LOOP
 * \brief Finish of loop to process household_bank_init_mortgages messages. */
#define FINISH_HOUSEHOLD_BANK_INIT_MORTGAGES_MESSAGE_LOOP }
/** \def START_HOUSEHOLD_BANK_INIT_DEPOSIT_MESSAGE_LOOP
 * \brief Start of loop to process household_bank_init_deposit messages. */
...
/** \def FINISH_HOUSEHOLD_BANK_INIT_DEPOSIT_MESSAGE_LOOP
 * \brief Finish of loop to process household_bank_init_deposit messages. */
...
/** \def START_BANK_CENTRALBANK_INIT_DEBT_MESSAGE_LOOP
 * \brief Start of loop to process bank_centralbank_init_debt messages. */
...
/** \def FINISH_BANK_CENTRALBANK_INIT_DEBT_MESSAGE_LOOP
 * \brief Finish of loop to process bank_centralbank_init_debt messages. */
#define FINISH_BANK_CENTRALBANK_INIT_DEBT_MESSAGE_LOOP }
/** \def START_BANK_CENTRALBANK_INIT_DEPOSIT_MESSAGE_LOOP
 * \brief Start of loop to process bank_centralbank_init_deposit messages. */
...
/** \def FINISH_BANK_CENTRALBANK_INIT_DEPOSIT_MESSAGE_LOOP
 * \brief Finish of loop to process bank_centralbank_init_deposit messages. */
#define FINISH_BANK_CENTRALBANK_INIT_DEPOSIT_MESSAGE_LOOP }
/** \def START_BANK_CENTRALBANK_UPDATE_DEPOSIT_MESSAGE_LOOP
 * \brief Start of loop to process bank_centralbank_update_deposit messages. */
...
/** \def FINISH_BANK_CENTRALBANK_UPDATE_DEPOSIT_MESSAGE_LOOP
 * \brief Finish of loop to process bank_centralbank_update_deposit messages. */
#define FINISH_BANK_CENTRALBANK_UPDATE_DEPOSIT_MESSAGE_LOOP }
/** \def START_FUND_CENTRALBANK_INIT_DEPOSIT_MESSAGE_LOOP
 * \brief Start of loop to process fund_centralbank_init_deposit messages. */
...
/** \def FINISH_FUND_CENTRALBANK_INIT_DEPOSIT_MESSAGE_LOOP
 * \brief Finish of loop to process fund_centralbank_init_deposit messages. */
#define FINISH_FUND_CENTRALBANK_INIT_DEPOSIT_MESSAGE_LOOP }
/** \def START_FUND_CENTRALBANK_UPDATE_DEPOSIT_MESSAGE_LOOP
 * \brief Start of loop to process fund_centralbank_update_deposit messages. */
...
/** \def FINISH_FUND_CENTRALBANK_UPDATE_DEPOSIT_MESSAGE_LOOP
 * \brief Finish of loop to process fund_centralbank_update_deposit messages. */
#define FINISH_FUND_CENTRALBANK_UPDATE_DEPOSIT_MESSAGE_LOOP }
/** \def START_GOV_CENTRALBANK_INIT_DEPOSIT_MESSAGE_LOOP
 * \brief Start of loop to process gov_centralbank_init_deposit messages. */
...
/** \def FINISH_GOV_CENTRALBANK_INIT_DEPOSIT_MESSAGE_LOOP
 * \brief Finish of loop to process gov_centralbank_init_deposit messages. */
#define FINISH_GOV_CENTRALBANK_INIT_DEPOSIT_MESSAGE_LOOP }
/** \def START_GOV_CENTRALBANK_UPDATE_DEPOSIT_MESSAGE_LOOP
 * \brief Start of loop to process gov_centralbank_update_deposit messages. */
...
/** \def FINISH_GOV_CENTRALBANK_UPDATE_DEPOSIT_MESSAGE_LOOP
 * \brief Finish of loop to process gov_centralbank_update_deposit messages. */
...
/** \def START_CAPITAL_TAX_RATE_MESSAGE_LOOP
 * \brief Start of loop to process capital_tax_rate messages. */
...
/** \def FINISH_CAPITAL_TAX_RATE_MESSAGE_LOOP
 * \brief Finish of loop to process capital_tax_rate messages. */
#define FINISH_CAPITAL_TAX_RATE_MESSAGE_LOOP }
/** \def START_LABOUR_TAX_RATE_MESSAGE_LOOP
 * \brief Start of loop to process labour_tax_rate messages. */
...
/** \def FINISH_LABOUR_TAX_RATE_MESSAGE_LOOP
 * \brief Finish of loop to process labour_tax_rate messages. */
#define FINISH_LABOUR_TAX_RATE_MESSAGE_LOOP }
/** \def START_HOUSEHOLD_JPOFFICE_ID_MESSAGE_LOOP
 * \brief Start of loop to process household_jpoffice_id messages. */
...
/** \def FINISH_HOUSEHOLD_JPOFFICE_ID_MESSAGE_LOOP
 * \brief Finish of loop to process household_jpoffice_id messages. */
#define FINISH_HOUSEHOLD_JPOFFICE_ID_MESSAGE_LOOP }
/** \def START_JPOFFICE_HOUSEHOLD_EMPLOYER_MESSAGE_LOOP
 * \brief Start of loop to process jpoffice_household_employer messages. */
...
/** \def FINISH_JPOFFICE_HOUSEHOLD_EMPLOYER_MESSAGE_LOOP
 * \brief Finish of loop to process jpoffice_household_employer messages. */
#define FINISH_JPOFFICE_HOUSEHOLD_EMPLOYER_MESSAGE_LOOP }
/** \def START_FIRM_JPOFFICE_ID_MESSAGE_LOOP
 * \brief Start of loop to process firm_jpoffice_id messages. */
...
/** \def FINISH_FIRM_JPOFFICE_ID_MESSAGE_LOOP
 * \brief Finish of loop to process firm_jpoffice_id messages. */
#define FINISH_FIRM_JPOFFICE_ID_MESSAGE_LOOP }
/** \def START_JPOFFICE_FIRM_EMPLOYEE_MESSAGE_LOOP
 * \brief Start of loop to process jpoffice_firm_employee messages. */
...
/** \def FINISH_JPOFFICE_FIRM_EMPLOYEE_MESSAGE_LOOP
 * \brief Finish of loop to process jpoffice_firm_employee messages. */
...
/** \def START_FIRM_HOUSEHOLD_WAGE_PAYMENT_MESSAGE_LOOP
 * \brief Start of loop to process firm_household_wage_payment messages. */
...
/** \def FINISH_FIRM_HOUSEHOLD_WAGE_PAYMENT_MESSAGE_LOOP
 * \brief Finish of loop to process firm_household_wage_payment messages. */
#define FINISH_FIRM_HOUSEHOLD_WAGE_PAYMENT_MESSAGE_LOOP }
/** \def START_FIRM_BANK_LOAN_REQUEST_1_MESSAGE_LOOP
 * \brief Start of loop to process firm_bank_loan_request_1 messages. */
...
/** \def FINISH_FIRM_BANK_LOAN_REQUEST_1_MESSAGE_LOOP
 * \brief Finish of loop to process firm_bank_loan_request_1 messages. */
#define FINISH_FIRM_BANK_LOAN_REQUEST_1_MESSAGE_LOOP }
/** \def START_FIRM_BANK_LOAN_REQUEST_2_MESSAGE_LOOP
 * \brief Start of loop to process firm_bank_loan_request_2 messages. */
...
/** \def FINISH_FIRM_BANK_LOAN_REQUEST_2_MESSAGE_LOOP
 * \brief Finish of loop to process firm_bank_loan_request_2 messages. */
#define FINISH_FIRM_BANK_LOAN_REQUEST_2_MESSAGE_LOOP }
/** \def START_BANK_FIRM_LOAN_ACKNOWLEDGE_1_MESSAGE_LOOP
 * \brief Start of loop to process bank_firm_loan_acknowledge_1 messages. */
...
/** \def FINISH_BANK_FIRM_LOAN_ACKNOWLEDGE_1_MESSAGE_LOOP
 * \brief Finish of loop to process bank_firm_loan_acknowledge_1 messages. */
#define FINISH_BANK_FIRM_LOAN_ACKNOWLEDGE_1_MESSAGE_LOOP }
/** \def START_BANK_FIRM_LOAN_ACKNOWLEDGE_2_MESSAGE_LOOP
 * \brief Start of loop to process bank_firm_loan_acknowledge_2 messages. */
...
/** \def FINISH_BANK_FIRM_LOAN_ACKNOWLEDGE_2_MESSAGE_LOOP
 * \brief Finish of loop to process bank_firm_loan_acknowledge_2 messages. */
#define FINISH_BANK_FIRM_LOAN_ACKNOWLEDGE_2_MESSAGE_LOOP }
/** \def START_BANK_CENTRALBANK_DEBT_REQUEST_MESSAGE_LOOP
 * \brief Start of loop to process bank_centralbank_debt_request messages. */
...
/** \def FINISH_BANK_CENTRALBANK_DEBT_REQUEST_MESSAGE_LOOP
 * \brief Finish of loop to process bank_centralbank_debt_request messages. */
...
/** \def START_FIRM_BANK_INTEREST_ON_LOAN_MESSAGE_LOOP
 * \brief Start of loop to process firm_bank_interest_on_loan messages. */
...
/** \def FINISH_FIRM_BANK_INTEREST_ON_LOAN_MESSAGE_LOOP
 * \brief Finish of loop to process firm_bank_interest_on_loan messages. */
...
/** \def START_FIRM_BANK_INSOLVENT_ACCOUNT_MESSAGE_LOOP
 * \brief Start of loop to process firm_bank_insolvent_account messages. */
...
/** \def FINISH_FIRM_BANK_INSOLVENT_ACCOUNT_MESSAGE_LOOP
 * \brief Finish of loop to process firm_bank_insolvent_account messages. */
...
/** \def START_GOV_CENTRALBANK_DEBT_REQUEST_MESSAGE_LOOP
 * \brief Start of loop to process gov_centralbank_debt_request messages. */
...
/** \def FINISH_GOV_CENTRALBANK_DEBT_REQUEST_MESSAGE_LOOP
 * \brief Finish of loop to process gov_centralbank_debt_request messages. */
#define FINISH_GOV_CENTRALBANK_DEBT_REQUEST_MESSAGE_LOOP }
/** \def START_GOV_CENTRALBANK_DEBT_PAYMENT_MESSAGE_LOOP
 * \brief Start of loop to process gov_centralbank_debt_payment messages. */
...
/** \def FINISH_GOV_CENTRALBANK_DEBT_PAYMENT_MESSAGE_LOOP
 * \brief Finish of loop to process gov_centralbank_debt_payment messages. */
...
/** \def START_BANK_REAGENCY_CREDIBILITY_MESSAGE_LOOP
 * \brief Start of loop to process bank_reagency_credibility messages. */
...
/** \def FINISH_BANK_REAGENCY_CREDIBILITY_MESSAGE_LOOP
 * \brief Finish of loop to process bank_reagency_credibility messages. */
...
/** \struct transaction
 * \brief Average price on overall transactions..
 *
 * Average price on overall transactions..
 */
struct transaction
{
...
/** \struct buyer
 * \brief Consumption budget to go..
 *
 * Consumption budget to go..
 */
struct buyer
{
...
/** \struct seller
 * \brief Inverse of price. It is used to decrease computation time at the mall..
 *
 * Inverse of price. It is used to decrease computation time at the mall..
 */
struct seller
{
	int id;	/**< Datatype memory variable id of type int. */
	...
	double inv_price;	/**< Datatype memory variable inv_price of type double. */
};
...
/** \struct vacancy
 * \brief Wage offered by the firm that holds the vacancy..
 *
 * Wage offered by the firm that holds the vacancy..
 */
struct vacancy
{
	int id;	/**< Datatype memory variable id of type int. */
...
/** \struct employee
 * \brief Current wage of the job applicant..
 *
 * Current wage of the job applicant..
 */
struct employee
{
	int id;	/**< Datatype memory variable id of type int. */
...
struct mortgage
{
	...
	double interestrate;	/**< Datatype memory variable interestrate of type double. */
	int mtype;	/**< Datatype memory variable mtype of type int. */
};
...
/** \struct hbuyer
 * \brief Mortgage choice of households while joining to housing market as a buyer..
 *
 * Mortgage choice of households while joining to housing market as a buyer..
 */
struct hbuyer
{
	...
	int choice;	/**< Datatype memory variable choice of type int. */
};
...
/** \struct hseller
 * \brief Seller Roles: 1 fire seller; 2 regular seller; 0 firm seller..
 *
 * Seller Roles: 1 fire seller; 2 regular seller; 0 firm seller..
 */
struct hseller
{
	...
	double price;	/**< Datatype memory variable price of type double. */
	int quantity;	/**< Datatype memory variable quantity of type int. */
	int type;	/**< Datatype memory variable type of type int. */
};
...
/** \struct hbank
 * \brief Amount of mortgage given out by the bank..
 *
 * Amount of mortgage given out by the bank..
 */
struct hbank
{
	int id;	/**< Datatype memory variable id of type int. */
...
struct xmachine_memory_firm
{
	...
	int manager;	/**< X-machine memory variable manager of type int. */
	...
	double capital_productivity;	/**< X-machine memory variable capital_productivity of type double. */
	int capital_goods;	/**< X-machine memory variable capital_goods of type int. */
	...
	int isliquidshort;	/**< X-machine memory variable isliquidshort of type int. */
	...
	int isilliquid;	/**< X-machine memory variable isilliquid of type int. */
	...
	double labour_tax_rate;	/**< X-machine memory variable labour_tax_rate of type double. */
...
struct xmachine_memory_household
{
	...
	double government_benefits;	/**< X-machine memory variable government_benefits of type double. */
	int day_of_month_to_act;	/**< X-machine memory variable day_of_month_to_act of type int. */
	...
	double previous_wages[3];	/**< X-machine memory variable previous_wages of type double. */
	double previous_benefits[3];	/**< X-machine memory variable previous_benefits of type double. */
	...
	double expected_housing_payment;	/**< X-machine memory variable expected_housing_payment of type double. */
	...
	int mortgage_choice;	/**< X-machine memory variable mortgage_choice of type int. */
};
...
struct xmachine_memory_equityfund
{
	...
	double capital_tax_rate;	/**< X-machine memory variable capital_tax_rate of type double. */
};
...
struct xmachine_memory_bank
{
	...
	double loans_start;	/**< X-machine memory variable loans_start of type double. */
	double mortgages;	/**< X-machine memory variable mortgages of type double. */
...
struct xmachine_memory_centralbank
{
	...
	double liquidity_equityfund;	/**< X-machine memory variable liquidity_equityfund of type double. */
	double total_assets;	/**< X-machine memory variable total_assets of type double. */
	double total_writeoffs;	/**< X-machine memory variable total_writeoffs of type double. */
	double interests_accrued;	/**< X-machine memory variable interests_accrued of type double. */
	double revenues;	/**< X-machine memory variable revenues of type double. */
...
/** \var void* FLAME_m_firm_bank_init_loans_composite_params\n
 ...
 * \brief Holds message of type firm_bank_init_loans_message.
 */
struct m_firm_bank_init_loans
{
...
/** \var void* FLAME_m_firm_bank_init_deposit_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_firm_bank_init_deposit_composite_params;

/** \struct m_firm_bank_init_deposit
 * \brief Holds message of type firm_bank_init_deposit_message.
 */
struct m_firm_bank_init_deposit
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \var void* FLAME_m_household_bank_init_mortgages_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_household_bank_init_mortgages_composite_params;

/** \struct m_household_bank_init_mortgages
 * \brief Holds message of type household_bank_init_mortgages_message.
 */
struct m_household_bank_init_mortgages
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \var void* FLAME_m_household_bank_init_deposit_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_household_bank_init_deposit_composite_params;

/** \struct m_household_bank_init_deposit
 * \brief Holds message of type household_bank_init_deposit_message.
 */
struct m_household_bank_init_deposit
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \var void* FLAME_m_bank_centralbank_init_debt_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_bank_centralbank_init_debt_composite_params;

/** \struct m_bank_centralbank_init_debt
 * \brief Holds message of type bank_centralbank_init_debt_message.
 */
struct m_bank_centralbank_init_debt
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \var void* FLAME_m_bank_centralbank_init_deposit_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_bank_centralbank_init_deposit_composite_params;

/** \struct m_bank_centralbank_init_deposit
 * \brief Holds message of type bank_centralbank_init_deposit_message.
 */
struct m_bank_centralbank_init_deposit
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \var void* FLAME_m_bank_centralbank_update_deposit_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_bank_centralbank_update_deposit_composite_params;

/** \struct m_bank_centralbank_update_deposit
 * \brief Holds message of type bank_centralbank_update_deposit_message.
 */
struct m_bank_centralbank_update_deposit
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \var void* FLAME_m_fund_centralbank_init_deposit_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_fund_centralbank_init_deposit_composite_params;

/** \struct m_fund_centralbank_init_deposit
 * \brief Holds message of type fund_centralbank_init_deposit_message.
 */
struct m_fund_centralbank_init_deposit
{
	double amount;	/**< Message memory variable amount of type double. */
...
/** \var void* FLAME_m_fund_centralbank_update_deposit_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_fund_centralbank_update_deposit_composite_params;

/** \struct m_fund_centralbank_update_deposit
 * \brief Holds message of type fund_centralbank_update_deposit_message.
 */
struct m_fund_centralbank_update_deposit
{
	double amount;	/**< Message memory variable amount of type double. */
...
/** \var void* FLAME_m_gov_centralbank_init_deposit_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_gov_centralbank_init_deposit_composite_params;

/** \struct m_gov_centralbank_init_deposit
 * \brief Holds message of type gov_centralbank_init_deposit_message.
 */
struct m_gov_centralbank_init_deposit
{
	double amount;	/**< Message memory variable amount of type double. */
...
/** \var void* FLAME_m_gov_centralbank_update_deposit_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_gov_centralbank_update_deposit_composite_params;

/** \struct m_gov_centralbank_update_deposit
 * \brief Holds message of type gov_centralbank_update_deposit_message.
 */
struct m_gov_centralbank_update_deposit
{
	double amount;	/**< Message memory variable amount of type double. */
...
/** \var void* FLAME_m_capital_tax_rate_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_capital_tax_rate_composite_params;

/** \struct m_capital_tax_rate
 * \brief Holds message of type capital_tax_rate_message.
 */
struct m_capital_tax_rate
{
...
/** \var void* FLAME_m_labour_tax_rate_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_labour_tax_rate_composite_params;

/** \struct m_labour_tax_rate
 * \brief Holds message of type labour_tax_rate_message.
 */
struct m_labour_tax_rate
{
	double value;	/**< Message memory variable value of type double. */
...
/** \var void* FLAME_m_household_jpoffice_id_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_household_jpoffice_id_composite_params;

/** \struct m_household_jpoffice_id
 * \brief Holds message of type household_jpoffice_id_message.
 */
struct m_household_jpoffice_id
{
...
/** \var void* FLAME_m_jpoffice_household_employer_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_jpoffice_household_employer_composite_params;

/** \struct m_jpoffice_household_employer
 * \brief Holds message of type jpoffice_household_employer_message.
 */
struct m_jpoffice_household_employer
{
	int household_id;	/**< Message memory variable household_id of type int. */
	int employer_id;	/**< Message memory variable employer_id of type int. */
	int position;	/**< Message memory variable position of type int. */
};

/** \var void* FLAME_m_firm_jpoffice_id_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_firm_jpoffice_id_composite_params;

/** \struct m_firm_jpoffice_id
 * \brief Holds message of type firm_jpoffice_id_message.
 */
struct m_firm_jpoffice_id
{
...
/** \var void* FLAME_m_jpoffice_firm_employee_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_jpoffice_firm_employee_composite_params;

/** \struct m_jpoffice_firm_employee
 * \brief Holds message of type jpoffice_firm_employee_message.
 */
struct m_jpoffice_firm_employee
{
	int firm_id;	/**< Message memory variable firm_id of type int. */
...
{
	int id;	/**< Message memory variable id of type int. */
	double money_spent;	/**< Message memory variable money_spent of type double. */
	int received_quantity;	/**< Message memory variable received_quantity of type int. */
};
...
{
	int id;	/**< Message memory variable id of type int. */
	int sold_quantities;	/**< Message memory variable sold_quantities of type int. */
};
...
/** \var void* FLAME_m_firm_household_wage_payment_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_firm_household_wage_payment_composite_params;

/** \struct m_firm_household_wage_payment
 * \brief Holds message of type firm_household_wage_payment_message.
 */
struct m_firm_household_wage_payment
{
	int firm_id;	/**< Message memory variable firm_id of type int. */
...
/** \var void* FLAME_m_firm_bank_loan_request_1_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_firm_bank_loan_request_1_composite_params;

/** \struct m_firm_bank_loan_request_1
 * \brief Holds message of type firm_bank_loan_request_1_message.
 */
struct m_firm_bank_loan_request_1
{
	int firm_id;	/**< Message memory variable firm_id of type int. */
...
/** \var void* FLAME_m_firm_bank_loan_request_2_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_firm_bank_loan_request_2_composite_params;

/** \struct m_firm_bank_loan_request_2
 * \brief Holds message of type firm_bank_loan_request_2_message.
 */
struct m_firm_bank_loan_request_2
{
	int firm_id;	/**< Message memory variable firm_id of type int. */
...
/** \var void* FLAME_m_bank_firm_loan_acknowledge_1_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_bank_firm_loan_acknowledge_1_composite_params;

/** \struct m_bank_firm_loan_acknowledge_1
 * \brief Holds message of type bank_firm_loan_acknowledge_1_message.
 */
struct m_bank_firm_loan_acknowledge_1
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \var void* FLAME_m_bank_firm_loan_acknowledge_2_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_bank_firm_loan_acknowledge_2_composite_params;

/** \struct m_bank_firm_loan_acknowledge_2
 * \brief Holds message of type bank_firm_loan_acknowledge_2_message.
 */
struct m_bank_firm_loan_acknowledge_2
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \var void* FLAME_m_bank_centralbank_debt_request_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_bank_centralbank_debt_request_composite_params;

/** \struct m_bank_centralbank_debt_request
 * \brief Holds message of type bank_centralbank_debt_request_message.
 */
struct m_bank_centralbank_debt_request
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \var void* FLAME_m_firm_bank_interest_on_loan_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_firm_bank_interest_on_loan_composite_params;

/** \struct m_firm_bank_interest_on_loan
 * \brief Holds message of type firm_bank_interest_on_loan_message.
 */
struct m_firm_bank_interest_on_loan
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \var void* FLAME_m_firm_bank_insolvent_account_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_firm_bank_insolvent_account_composite_params;

/** \struct m_firm_bank_insolvent_account
 * \brief Holds message of type firm_bank_insolvent_account_message.
 */
struct m_firm_bank_insolvent_account
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \var void* FLAME_m_gov_centralbank_debt_request_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_gov_centralbank_debt_request_composite_params;

/** \struct m_gov_centralbank_debt_request
 * \brief Holds message of type gov_centralbank_debt_request_message.
 */
struct m_gov_centralbank_debt_request
{
	double amount;	/**< Message memory variable amount of type double. */
...
/** \var void* FLAME_m_gov_centralbank_debt_payment_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_gov_centralbank_debt_payment_composite_params;

/** \struct m_gov_centralbank_debt_payment
 * \brief Holds message of type gov_centralbank_debt_payment_message.
 */
struct m_gov_centralbank_debt_payment
{
	double amount;	/**< Message memory variable amount of type double. */
...
struct m_buy_housing
{
	...
	int mortgage_choice;	/**< Message memory variable mortgage_choice of type int. */
};
...
struct m_sell_housing
{
	...
	double price;	/**< Message memory variable price of type double. */
	int quantity;	/**< Message memory variable quantity of type int. */
	int type;	/**< Message memory variable type of type int. */
};
...
/** \var void* FLAME_m_bank_reagency_credibility_composite_params\n
 * \brief Pointer to message sync agent composite params */
void* FLAME_m_bank_reagency_credibility_composite_params;

/** \struct m_bank_reagency_credibility
 * \brief Holds message of type bank_reagency_credibility_message.
 */
struct m_bank_reagency_credibility
{
	int bank_id;	/**< Message memory variable bank_id of type int. */
...
/** \typedef m_firm_bank_init_loans m_firm_bank_init_loans
 * \brief Typedef for m_firm_bank_init_loans struct.
 */
typedef struct m_firm_bank_init_loans m_firm_bank_init_loans;

/** \typedef m_firm_bank_init_deposit m_firm_bank_init_deposit
 * \brief Typedef for m_firm_bank_init_deposit struct.
 */
typedef struct m_firm_bank_init_deposit m_firm_bank_init_deposit;
...
/** \typedef m_household_bank_init_mortgages m_household_bank_init_mortgages
 * \brief Typedef for m_household_bank_init_mortgages struct.
 */
typedef struct m_household_bank_init_mortgages m_household_bank_init_mortgages;

/** \typedef m_household_bank_init_deposit m_household_bank_init_deposit
 * \brief Typedef for m_household_bank_init_deposit struct.
 */
typedef struct m_household_bank_init_deposit m_household_bank_init_deposit;
...
/** \typedef m_bank_centralbank_init_debt m_bank_centralbank_init_debt
 * \brief Typedef for m_bank_centralbank_init_debt struct.
 */
typedef struct m_bank_centralbank_init_debt m_bank_centralbank_init_debt;

/** \typedef m_bank_centralbank_init_deposit m_bank_centralbank_init_deposit
 * \brief Typedef for m_bank_centralbank_init_deposit struct.
 */
typedef struct m_bank_centralbank_init_deposit m_bank_centralbank_init_deposit;

/** \typedef m_bank_centralbank_update_deposit m_bank_centralbank_update_deposit
 * \brief Typedef for m_bank_centralbank_update_deposit struct.
 */
typedef struct m_bank_centralbank_update_deposit m_bank_centralbank_update_deposit;

/** \typedef m_fund_centralbank_init_deposit m_fund_centralbank_init_deposit
 * \brief Typedef for m_fund_centralbank_init_deposit struct.
 */
typedef struct m_fund_centralbank_init_deposit m_fund_centralbank_init_deposit;

/** \typedef m_fund_centralbank_update_deposit m_fund_centralbank_update_deposit
 * \brief Typedef for m_fund_centralbank_update_deposit struct.
 */
typedef struct m_fund_centralbank_update_deposit m_fund_centralbank_update_deposit;

/** \typedef m_gov_centralbank_init_deposit m_gov_centralbank_init_deposit
 * \brief Typedef for m_gov_centralbank_init_deposit struct.
 */
typedef struct m_gov_centralbank_init_deposit m_gov_centralbank_init_deposit;

/** \typedef m_gov_centralbank_update_deposit m_gov_centralbank_update_deposit
 * \brief Typedef for m_gov_centralbank_update_deposit struct.
 */
typedef struct m_gov_centralbank_update_deposit m_gov_centralbank_update_deposit;
...
/** \typedef m_capital_tax_rate m_capital_tax_rate
 * \brief Typedef for m_capital_tax_rate struct.
 */
typedef struct m_capital_tax_rate m_capital_tax_rate;

/** \typedef m_labour_tax_rate m_labour_tax_rate
 * \brief Typedef for m_labour_tax_rate struct.
 */
typedef struct m_labour_tax_rate m_labour_tax_rate;

/** \typedef m_household_jpoffice_id m_household_jpoffice_id
 * \brief Typedef for m_household_jpoffice_id struct.
 */
typedef struct m_household_jpoffice_id m_household_jpoffice_id;

/** \typedef m_jpoffice_household_employer m_jpoffice_household_employer
 * \brief Typedef for m_jpoffice_household_employer struct.
 */
typedef struct m_jpoffice_household_employer m_jpoffice_household_employer;

/** \typedef m_firm_jpoffice_id m_firm_jpoffice_id
 * \brief Typedef for m_firm_jpoffice_id struct.
 */
typedef struct m_firm_jpoffice_id m_firm_jpoffice_id;

/** \typedef m_jpoffice_firm_employee m_jpoffice_firm_employee
 * \brief Typedef for m_jpoffice_firm_employee struct.
 */
typedef struct m_jpoffice_firm_employee m_jpoffice_firm_employee;
...
/** \typedef m_firm_household_wage_payment m_firm_household_wage_payment
 * \brief Typedef for m_firm_household_wage_payment struct.
 */
typedef struct m_firm_household_wage_payment m_firm_household_wage_payment;

/** \typedef m_firm_bank_loan_request_1 m_firm_bank_loan_request_1
 * \brief Typedef for m_firm_bank_loan_request_1 struct.
 */
typedef struct m_firm_bank_loan_request_1 m_firm_bank_loan_request_1;

/** \typedef m_firm_bank_loan_request_2 m_firm_bank_loan_request_2
 * \brief Typedef for m_firm_bank_loan_request_2 struct.
 */
typedef struct m_firm_bank_loan_request_2 m_firm_bank_loan_request_2;

/** \typedef m_bank_firm_loan_acknowledge_1 m_bank_firm_loan_acknowledge_1
 * \brief Typedef for m_bank_firm_loan_acknowledge_1 struct.
 */
typedef struct m_bank_firm_loan_acknowledge_1 m_bank_firm_loan_acknowledge_1;

/** \typedef m_bank_firm_loan_acknowledge_2 m_bank_firm_loan_acknowledge_2
 * \brief Typedef for m_bank_firm_loan_acknowledge_2 struct.
 */
typedef struct m_bank_firm_loan_acknowledge_2 m_bank_firm_loan_acknowledge_2;

/** \typedef m_bank_centralbank_debt_request m_bank_centralbank_debt_request
 * \brief Typedef for m_bank_centralbank_debt_request struct.
 */
typedef struct m_bank_centralbank_debt_request m_bank_centralbank_debt_request;
...
/** \typedef m_firm_bank_interest_on_loan m_firm_bank_interest_on_loan
 * \brief Typedef for m_firm_bank_interest_on_loan struct.
 */
typedef struct m_firm_bank_interest_on_loan m_firm_bank_interest_on_loan;
...
/** \typedef m_firm_bank_insolvent_account m_firm_bank_insolvent_account
 * \brief Typedef for m_firm_bank_insolvent_account struct.
 */
typedef struct m_firm_bank_insolvent_account m_firm_bank_insolvent_account;
...
/** \typedef m_gov_centralbank_debt_request m_gov_centralbank_debt_request
 * \brief Typedef for m_gov_centralbank_debt_request struct.
 */
typedef struct m_gov_centralbank_debt_request m_gov_centralbank_debt_request;

/** \typedef m_gov_centralbank_debt_payment m_gov_centralbank_debt_payment
 * \brief Typedef for m_gov_centralbank_debt_payment struct.
 */
typedef struct m_gov_centralbank_debt_payment m_gov_centralbank_debt_payment;
...
/** \typedef m_bank_reagency_credibility m_bank_reagency_credibility
 * \brief Typedef for m_bank_reagency_credibility struct.
 */
typedef struct m_bank_reagency_credibility m_bank_reagency_credibility;
...
struct node_information
{
	...
	struct m_firm_bank_init_loans * firm_bank_init_loans_messages;	/**< Pointer to firm_bank_init_loans message list. */
	struct m_firm_bank_init_deposit * firm_bank_init_deposit_messages;	/**< Pointer to firm_bank_init_deposit message list. */
	struct m_firm_bank_update_deposit * firm_bank_update_deposit_messages;	/**< Pointer to firm_bank_update_deposit message list. */
	struct m_household_bank_init_mortgages * household_bank_init_mortgages_messages;	/**< Pointer to household_bank_init_mortgages message list. */
	struct m_household_bank_init_deposit * household_bank_init_deposit_messages;	/**< Pointer to household_bank_init_deposit message list. */
	...
	struct m_bank_centralbank_init_debt * bank_centralbank_init_debt_messages;	/**< Pointer to bank_centralbank_init_debt message list. */
	struct m_bank_centralbank_init_deposit * bank_centralbank_init_deposit_messages;	/**< Pointer to bank_centralbank_init_deposit message list. */
	struct m_bank_centralbank_update_deposit * bank_centralbank_update_deposit_messages;	/**< Pointer to bank_centralbank_update_deposit message list. */
	struct m_fund_centralbank_init_deposit * fund_centralbank_init_deposit_messages;	/**< Pointer to fund_centralbank_init_deposit message list. */
	struct m_fund_centralbank_update_deposit * fund_centralbank_update_deposit_messages;	/**< Pointer to fund_centralbank_update_deposit message list. */
	struct m_gov_centralbank_init_deposit * gov_centralbank_init_deposit_messages;	/**< Pointer to gov_centralbank_init_deposit message list. */
	struct m_gov_centralbank_update_deposit * gov_centralbank_update_deposit_messages;	/**< Pointer to gov_centralbank_update_deposit message list. */
	struct m_interest_rate * interest_rate_messages;	/**< Pointer to interest_rate message list. */
	struct m_capital_tax_rate * capital_tax_rate_messages;	/**< Pointer to capital_tax_rate message list. */
	struct m_labour_tax_rate * labour_tax_rate_messages;	/**< Pointer to labour_tax_rate message list. */
	struct m_household_jpoffice_id * household_jpoffice_id_messages;	/**< Pointer to household_jpoffice_id message list. */
	struct m_jpoffice_household_employer * jpoffice_household_employer_messages;	/**< Pointer to jpoffice_household_employer message list. */
	struct m_firm_jpoffice_id * firm_jpoffice_id_messages;	/**< Pointer to firm_jpoffice_id message list. */
	struct m_jpoffice_firm_employee * jpoffice_firm_employee_messages;	/**< Pointer to jpoffice_firm_employee message list. */
	...
	struct m_firm_household_wage_payment * firm_household_wage_payment_messages;	/**< Pointer to firm_household_wage_payment message list. */
	struct m_firm_bank_loan_request_1 * firm_bank_loan_request_1_messages;	/**< Pointer to firm_bank_loan_request_1 message list. */
	struct m_firm_bank_loan_request_2 * firm_bank_loan_request_2_messages;	/**< Pointer to firm_bank_loan_request_2 message list. */
	struct m_bank_firm_loan_acknowledge_1 * bank_firm_loan_acknowledge_1_messages;	/**< Pointer to bank_firm_loan_acknowledge_1 message list. */
	struct m_bank_firm_loan_acknowledge_2 * bank_firm_loan_acknowledge_2_messages;	/**< Pointer to bank_firm_loan_acknowledge_2 message list. */
	struct m_bank_centralbank_debt_request * bank_centralbank_debt_request_messages;	/**< Pointer to bank_centralbank_debt_request message list. */
	...
	struct m_firm_bank_interest_on_loan * firm_bank_interest_on_loan_messages;	/**< Pointer to firm_bank_interest_on_loan message list. */
	struct m_loan_writeoff * loan_writeoff_messages;	/**< Pointer to loan_writeoff message list. */
	struct m_firm_bank_insolvent_account * firm_bank_insolvent_account_messages;	/**< Pointer to firm_bank_insolvent_account message list. */
	...
	struct m_gov_centralbank_debt_request * gov_centralbank_debt_request_messages;	/**< Pointer to gov_centralbank_debt_request message list. */
	struct m_gov_centralbank_debt_payment * gov_centralbank_debt_payment_messages;	/**< Pointer to gov_centralbank_debt_payment message list. */
	...
	struct m_bank_reagency_credibility * bank_reagency_credibility_messages;	/**< Pointer to bank_reagency_credibility message list. */
...
/** \var m_firm_bank_init_loans * temp_firm_bank_init_loans_message
* \brief Pointer to m_firm_bank_init_loans to initialise linked list. */
m_firm_bank_init_loans * temp_firm_bank_init_loans_message;
/** \var m_firm_bank_init_deposit * temp_firm_bank_init_deposit_message
* \brief Pointer to m_firm_bank_init_deposit to initialise linked list. */
...
/** \var m_household_bank_init_mortgages * temp_household_bank_init_mortgages_message
* \brief Pointer to m_household_bank_init_mortgages to initialise linked list. */
m_household_bank_init_mortgages * temp_household_bank_init_mortgages_message;
/** \var m_household_bank_init_deposit * temp_household_bank_init_deposit_message
* \brief Pointer to m_household_bank_init_deposit to initialise linked list. */
...
/** \var m_bank_centralbank_init_debt * temp_bank_centralbank_init_debt_message
* \brief Pointer to m_bank_centralbank_init_debt to initialise linked list. */
m_bank_centralbank_init_debt * temp_bank_centralbank_init_debt_message;
/** \var m_bank_centralbank_init_deposit * temp_bank_centralbank_init_deposit_message
* \brief Pointer to m_bank_centralbank_init_deposit to initialise linked list. */
m_bank_centralbank_init_deposit * temp_bank_centralbank_init_deposit_message;
/** \var m_bank_centralbank_update_deposit * temp_bank_centralbank_update_deposit_message
* \brief Pointer to m_bank_centralbank_update_deposit to initialise linked list. */
m_bank_centralbank_update_deposit * temp_bank_centralbank_update_deposit_message;
/** \var m_fund_centralbank_init_deposit * temp_fund_centralbank_init_deposit_message
* \brief Pointer to m_fund_centralbank_init_deposit to initialise linked list. */
m_fund_centralbank_init_deposit * temp_fund_centralbank_init_deposit_message;
/** \var m_fund_centralbank_update_deposit * temp_fund_centralbank_update_deposit_message
* \brief Pointer to m_fund_centralbank_update_deposit to initialise linked list. */
m_fund_centralbank_update_deposit * temp_fund_centralbank_update_deposit_message;
/** \var m_gov_centralbank_init_deposit * temp_gov_centralbank_init_deposit_message
* \brief Pointer to m_gov_centralbank_init_deposit to initialise linked list. */
m_gov_centralbank_init_deposit * temp_gov_centralbank_init_deposit_message;
/** \var m_gov_centralbank_update_deposit * temp_gov_centralbank_update_deposit_message
* \brief Pointer to m_gov_centralbank_update_deposit to initialise linked list. */
...
/** \var m_capital_tax_rate * temp_capital_tax_rate_message
* \brief Pointer to m_capital_tax_rate to initialise linked list. */
m_capital_tax_rate * temp_capital_tax_rate_message;
/** \var m_labour_tax_rate * temp_labour_tax_rate_message
* \brief Pointer to m_labour_tax_rate to initialise linked list. */
m_labour_tax_rate * temp_labour_tax_rate_message;
/** \var m_household_jpoffice_id * temp_household_jpoffice_id_message
* \brief Pointer to m_household_jpoffice_id to initialise linked list. */
m_household_jpoffice_id * temp_household_jpoffice_id_message;
/** \var m_jpoffice_household_employer * temp_jpoffice_household_employer_message
* \brief Pointer to m_jpoffice_household_employer to initialise linked list. */
m_jpoffice_household_employer * temp_jpoffice_household_employer_message;
/** \var m_firm_jpoffice_id * temp_firm_jpoffice_id_message
* \brief Pointer to m_firm_jpoffice_id to initialise linked list. */
m_firm_jpoffice_id * temp_firm_jpoffice_id_message;
/** \var m_jpoffice_firm_employee * temp_jpoffice_firm_employee_message
* \brief Pointer to m_jpoffice_firm_employee to initialise linked list. */
...
/** \var m_firm_household_wage_payment * temp_firm_household_wage_payment_message
* \brief Pointer to m_firm_household_wage_payment to initialise linked list. */
m_firm_household_wage_payment * temp_firm_household_wage_payment_message;
/** \var m_firm_bank_loan_request_1 * temp_firm_bank_loan_request_1_message
* \brief Pointer to m_firm_bank_loan_request_1 to initialise linked list. */
m_firm_bank_loan_request_1 * temp_firm_bank_loan_request_1_message;
/** \var m_firm_bank_loan_request_2 * temp_firm_bank_loan_request_2_message
* \brief Pointer to m_firm_bank_loan_request_2 to initialise linked list. */
m_firm_bank_loan_request_2 * temp_firm_bank_loan_request_2_message;
/** \var m_bank_firm_loan_acknowledge_1 * temp_bank_firm_loan_acknowledge_1_message
* \brief Pointer to m_bank_firm_loan_acknowledge_1 to initialise linked list. */
m_bank_firm_loan_acknowledge_1 * temp_bank_firm_loan_acknowledge_1_message;
/** \var m_bank_firm_loan_acknowledge_2 * temp_bank_firm_loan_acknowledge_2_message
* \brief Pointer to m_bank_firm_loan_acknowledge_2 to initialise linked list. */
m_bank_firm_loan_acknowledge_2 * temp_bank_firm_loan_acknowledge_2_message;
/** \var m_bank_centralbank_debt_request * temp_bank_centralbank_debt_request_message
* \brief Pointer to m_bank_centralbank_debt_request to initialise linked list. */
...
/** \var m_firm_bank_interest_on_loan * temp_firm_bank_interest_on_loan_message
* \brief Pointer to m_firm_bank_interest_on_loan to initialise linked list. */
...
/** \var m_firm_bank_insolvent_account * temp_firm_bank_insolvent_account_message
* \brief Pointer to m_firm_bank_insolvent_account to initialise linked list. */
...
/** \var m_gov_centralbank_debt_request * temp_gov_centralbank_debt_request_message
* \brief Pointer to m_gov_centralbank_debt_request to initialise linked list. */
m_gov_centralbank_debt_request * temp_gov_centralbank_debt_request_message;
/** \var m_gov_centralbank_debt_payment * temp_gov_centralbank_debt_payment_message
* \brief Pointer to m_gov_centralbank_debt_payment to initialise linked list. */
...
/** \var m_bank_reagency_credibility * temp_bank_reagency_credibility_message
* \brief Pointer to m_bank_reagency_credibility to initialise linked list. */
...
/* Pointer to list of firm agents in state FirmReceiveSales state */
//xmachine_memory_firm * temp_xmachine_firm_FirmReceiveSales;
xmachine_memory_firm_state * firm_FirmReceiveSales_state;
/* Pointer to list of firm agents in state FirmConsumptionMarket state */
//xmachine_memory_firm * temp_xmachine_firm_FirmConsumptionMarket;
...
/* Pointer to list of firm agents in state FirmCreditPolicyChecks state */
//xmachine_memory_firm * temp_xmachine_firm_FirmCreditPolicyChecks;
...
/* Pointer to list of firm agents in state FirmInitBalanceSheet state */
//xmachine_memory_firm * temp_xmachine_firm_FirmInitBalanceSheet;
xmachine_memory_firm_state * firm_FirmInitBalanceSheet_state;
/* Pointer to list of firm agents in state FirmInitEmployment state */
//xmachine_memory_firm * temp_xmachine_firm_FirmInitEmployment;
xmachine_memory_firm_state * firm_FirmInitEmployment_state;
/* Pointer to list of firm agents in state FirmLoop state */
//xmachine_memory_firm * temp_xmachine_firm_FirmLoop;
xmachine_memory_firm_state * firm_FirmLoop_state;
/* Pointer to list of firm agents in state FirmInitPostId state */
//xmachine_memory_firm * temp_xmachine_firm_FirmInitPostId;
...
/* Pointer to list of household agents in state HHCreditUpdateAnnuity state */
//xmachine_memory_household * temp_xmachine_household_HHCreditUpdateAnnuity;
...
/* Pointer to list of household agents in state HHConsumptionMonthly state */
//xmachine_memory_household * temp_xmachine_household_HHConsumptionMonthly;
...
/* Pointer to list of household agents in state HHCreditPolicyChecks state */
//xmachine_memory_household * temp_xmachine_household_HHCreditPolicyChecks;
...
/* Pointer to list of household agents in state HouseholdInitBalanceSheet state */
//xmachine_memory_household * temp_xmachine_household_HouseholdInitBalanceSheet;
xmachine_memory_household_state * household_HouseholdInitBalanceSheet_state;
/* Pointer to list of household agents in state HouseholdInitEmployment state */
//xmachine_memory_household * temp_xmachine_household_HouseholdInitEmployment;
xmachine_memory_household_state * household_HouseholdInitEmployment_state;
/* Pointer to list of household agents in state HouseholdLoop state */
//xmachine_memory_household * temp_xmachine_household_HouseholdLoop;
xmachine_memory_household_state * household_HouseholdLoop_state;
/* Pointer to list of household agents in state HouseholdInitPostId state */
//xmachine_memory_household * temp_xmachine_household_HouseholdInitPostId;
...
/* Pointer to list of equityfund agents in state EFCreditPolicyChecks state */
//xmachine_memory_equityfund * temp_xmachine_equityfund_EFCreditPolicyChecks;
...
/* Pointer to list of equityfund agents in state EFCreditIncomeStatement state */
//xmachine_memory_equityfund * temp_xmachine_equityfund_EFCreditIncomeStatement;
...
/* Pointer to list of equityfund agents in state EquityFundCredit state */
//xmachine_memory_equityfund * temp_xmachine_equityfund_EquityFundCredit;
xmachine_memory_equityfund_state * equityfund_EquityFundCredit_state;
/* Pointer to list of equityfund agents in state EquityFundLoop state */
//xmachine_memory_equityfund * temp_xmachine_equityfund_EquityFundLoop;
...
/* Pointer to list of bank agents in state BankCreditPolicyChecks state */
//xmachine_memory_bank * temp_xmachine_bank_BankCreditPolicyChecks;
...
/* Pointer to list of bank agents in state BankInitBalanceSheet state */
//xmachine_memory_bank * temp_xmachine_bank_BankInitBalanceSheet;
xmachine_memory_bank_state * bank_BankInitBalanceSheet_state;
/* Pointer to list of bank agents in state BankInitDeposits state */
//xmachine_memory_bank * temp_xmachine_bank_BankInitDeposits;
xmachine_memory_bank_state * bank_BankInitDeposits_state;
/* Pointer to list of bank agents in state BankInitMortgages state */
//xmachine_memory_bank * temp_xmachine_bank_BankInitMortgages;
xmachine_memory_bank_state * bank_BankInitMortgages_state;
/* Pointer to list of bank agents in state BankLoop state */
//xmachine_memory_bank * temp_xmachine_bank_BankLoop;
xmachine_memory_bank_state * bank_BankLoop_state;
/* Pointer to list of bank agents in state BankInitLoans state */
//xmachine_memory_bank * temp_xmachine_bank_BankInitLoans;
...
/* Pointer to list of government agents in state GovernmentUpdatePolicy state */
//xmachine_memory_government * temp_xmachine_government_GovernmentUpdatePolicy;
...
/* Pointer to list of government agents in state GovernmentCredit state */
//xmachine_memory_government * temp_xmachine_government_GovernmentCredit;
xmachine_memory_government_state * government_GovernmentCredit_state;
/* Pointer to list of government agents in state GovernmentLoop state */
//xmachine_memory_government * temp_xmachine_government_GovernmentLoop;
...
/* Pointer to list of centralbank agents in state CentralBankUpdateInterestRate state */
//xmachine_memory_centralbank * temp_xmachine_centralbank_CentralBankUpdateInterestRate;
...
/* Pointer to list of centralbank agents in state CentralBankGovernmentRequests state */
//xmachine_memory_centralbank * temp_xmachine_centralbank_CentralBankGovernmentRequests;
...
/* Pointer to list of centralbank agents in state CentralBankPolicy state */
//xmachine_memory_centralbank * temp_xmachine_centralbank_CentralBankPolicy;
...
/* Pointer to list of centralbank agents in state CentralBankConsumptionPrices state */
//xmachine_memory_centralbank * temp_xmachine_centralbank_CentralBankConsumptionPrices;
...
/* Pointer to list of centralbank agents in state CentralBankLoop state */
//xmachine_memory_centralbank * temp_xmachine_centralbank_CentralBankLoop;
xmachine_memory_centralbank_state * centralbank_CentralBankLoop_state;
/* Pointer to list of centralbank agents in state CentralBankInitBalanceSheet state */
//xmachine_memory_centralbank * temp_xmachine_centralbank_CentralBankInitBalanceSheet;
...
/* Pointer to list of jpoffice agents in state JPOfficeLoop state */
//xmachine_memory_jpoffice * temp_xmachine_jpoffice_JPOfficeLoop;
xmachine_memory_jpoffice_state * jpoffice_JPOfficeLoop_state;
/* Pointer to list of jpoffice agents in state JPOfficeInitEmployment state */
//xmachine_memory_jpoffice * temp_xmachine_jpoffice_JPOfficeInitEmployment;
...
/* Pointer to list of reagency agents in state REAgencyCreditPolicyChecks state */
//xmachine_memory_reagency * temp_xmachine_reagency_REAgencyCreditPolicyChecks;
...
/** \var m_firm_bank_init_loans * firm_bank_init_loans_message
* \brief Pointer to message struct for looping through firm_bank_init_loans message list */
m_firm_bank_init_loans * firm_bank_init_loans_message;
/** \var m_firm_bank_init_deposit * firm_bank_init_deposit_message
* \brief Pointer to message struct for looping through firm_bank_init_deposit message list */
...
/** \var m_household_bank_init_mortgages * household_bank_init_mortgages_message
* \brief Pointer to message struct for looping through household_bank_init_mortgages message list */
m_household_bank_init_mortgages * household_bank_init_mortgages_message;
/** \var m_household_bank_init_deposit * household_bank_init_deposit_message
* \brief Pointer to message struct for looping through household_bank_init_deposit message list */
...
/** \var m_bank_centralbank_init_debt * bank_centralbank_init_debt_message
* \brief Pointer to message struct for looping through bank_centralbank_init_debt message list */
m_bank_centralbank_init_debt * bank_centralbank_init_debt_message;
/** \var m_bank_centralbank_init_deposit * bank_centralbank_init_deposit_message
* \brief Pointer to message struct for looping through bank_centralbank_init_deposit message list */
m_bank_centralbank_init_deposit * bank_centralbank_init_deposit_message;
/** \var m_bank_centralbank_update_deposit * bank_centralbank_update_deposit_message
* \brief Pointer to message struct for looping through bank_centralbank_update_deposit message list */
m_bank_centralbank_update_deposit * bank_centralbank_update_deposit_message;
/** \var m_fund_centralbank_init_deposit * fund_centralbank_init_deposit_message
* \brief Pointer to message struct for looping through fund_centralbank_init_deposit message list */
m_fund_centralbank_init_deposit * fund_centralbank_init_deposit_message;
/** \var m_fund_centralbank_update_deposit * fund_centralbank_update_deposit_message
* \brief Pointer to message struct for looping through fund_centralbank_update_deposit message list */
m_fund_centralbank_update_deposit * fund_centralbank_update_deposit_message;
/** \var m_gov_centralbank_init_deposit * gov_centralbank_init_deposit_message
* \brief Pointer to message struct for looping through gov_centralbank_init_deposit message list */
m_gov_centralbank_init_deposit * gov_centralbank_init_deposit_message;
/** \var m_gov_centralbank_update_deposit * gov_centralbank_update_deposit_message
* \brief Pointer to message struct for looping through gov_centralbank_update_deposit message list */
...
/** \var m_capital_tax_rate * capital_tax_rate_message
* \brief Pointer to message struct for looping through capital_tax_rate message list */
m_capital_tax_rate * capital_tax_rate_message;
/** \var m_labour_tax_rate * labour_tax_rate_message
* \brief Pointer to message struct for looping through labour_tax_rate message list */
m_labour_tax_rate * labour_tax_rate_message;
/** \var m_household_jpoffice_id * household_jpoffice_id_message
* \brief Pointer to message struct for looping through household_jpoffice_id message list */
m_household_jpoffice_id * household_jpoffice_id_message;
/** \var m_jpoffice_household_employer * jpoffice_household_employer_message
* \brief Pointer to message struct for looping through jpoffice_household_employer message list */
m_jpoffice_household_employer * jpoffice_household_employer_message;
/** \var m_firm_jpoffice_id * firm_jpoffice_id_message
* \brief Pointer to message struct for looping through firm_jpoffice_id message list */
m_firm_jpoffice_id * firm_jpoffice_id_message;
/** \var m_jpoffice_firm_employee * jpoffice_firm_employee_message
* \brief Pointer to message struct for looping through jpoffice_firm_employee message list */
...
/** \var m_firm_household_wage_payment * firm_household_wage_payment_message
* \brief Pointer to message struct for looping through firm_household_wage_payment message list */
m_firm_household_wage_payment * firm_household_wage_payment_message;
/** \var m_firm_bank_loan_request_1 * firm_bank_loan_request_1_message
* \brief Pointer to message struct for looping through firm_bank_loan_request_1 message list */
m_firm_bank_loan_request_1 * firm_bank_loan_request_1_message;
/** \var m_firm_bank_loan_request_2 * firm_bank_loan_request_2_message
* \brief Pointer to message struct for looping through firm_bank_loan_request_2 message list */
m_firm_bank_loan_request_2 * firm_bank_loan_request_2_message;
/** \var m_bank_firm_loan_acknowledge_1 * bank_firm_loan_acknowledge_1_message
* \brief Pointer to message struct for looping through bank_firm_loan_acknowledge_1 message list */
m_bank_firm_loan_acknowledge_1 * bank_firm_loan_acknowledge_1_message;
/** \var m_bank_firm_loan_acknowledge_2 * bank_firm_loan_acknowledge_2_message
* \brief Pointer to message struct for looping through bank_firm_loan_acknowledge_2 message list */
m_bank_firm_loan_acknowledge_2 * bank_firm_loan_acknowledge_2_message;
/** \var m_bank_centralbank_debt_request * bank_centralbank_debt_request_message
* \brief Pointer to message struct for looping through bank_centralbank_debt_request message list */
...
/** \var m_firm_bank_interest_on_loan * firm_bank_interest_on_loan_message
* \brief Pointer to message struct for looping through firm_bank_interest_on_loan message list */
...
/** \var m_firm_bank_insolvent_account * firm_bank_insolvent_account_message
* \brief Pointer to message struct for looping through firm_bank_insolvent_account message list */
...
/** \var m_gov_centralbank_debt_request * gov_centralbank_debt_request_message
* \brief Pointer to message struct for looping through gov_centralbank_debt_request message list */
m_gov_centralbank_debt_request * gov_centralbank_debt_request_message;
/** \var m_gov_centralbank_debt_payment * gov_centralbank_debt_payment_message
* \brief Pointer to message struct for looping through gov_centralbank_debt_payment message list */
...
/** \var m_bank_reagency_credibility * bank_reagency_credibility_message
* \brief Pointer to message struct for looping through bank_reagency_credibility message list */
