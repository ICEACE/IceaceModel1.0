...
/** \fn int FLAME_condition_firm_idle_FirmConsumptionMarket_FirmHousingStart(xmachine_memory_firm *a)
 * \brief The condition function for an agent function.
 * \param a The agent memory.
 * \return The success (1) or failure (0) of the condition.
 */
...
/** \fn int FLAME_condition_household_idle_HHConsumptionWeekly_HHConsumptionMonthly(xmachine_memory_household *a)
 * \brief The condition function for an agent function.
 * \param a The agent memory.
 * \return The success (1) or failure (0) of the condition.
 */
...
/** \fn int FLAME_condition_household_idle_HHConsumptionMonthly_HHHousingStart(xmachine_memory_household *a)
 * \brief The condition function for an agent function.
 * \param a The agent memory.
 * \return The success (1) or failure (0) of the condition.
 */
...
/** \fn int FLAME_condition_household_household_consumption_trace_cpi_HHConsumptionMonthly_HHHousingStart(xmachine_memory_household *a)
 * \brief The condition function for an agent function.
 * \param a The agent memory.
 * \return The success (1) or failure (0) of the condition.
 */
...
/** \fn int FLAME_condition_centralbank_idle_CentralBankConsumptionPrices_CentralBankHousing(xmachine_memory_centralbank *a)
 * \brief The condition function for an agent function.
 * \param a The agent memory.
 * \return The success (1) or failure (0) of the condition.
 */
...
/** \fn int FLAME_condition_centralbank_centralbank_update_price_indices_CentralBankConsumptionPrices_CentralBankHousing(xmachine_memory_centralbank *a)
 * \brief The condition function for an agent function.
 * \param a The agent memory.
 * \return The success (1) or failure (0) of the condition.
 */
...
/** \fn int FLAME_filter_household_household_consumption_recieve_goods_HHConsumptionRecieveGoods_HHConsumptionMonthly_bought(const void *msg, const void *params)
 * \brief The filter function for a message input used in serial for each agent.
 * \param msg The pointer to the message to be filtered.
 * \param params The pointer to the agent memory.
 * \return The success (1) or failure (0) of the filter on the message.
