...
/** \fn void add_jpoffice_household_employer_message(int household_id, int employer_id, int position)
 * \brief Add jpoffice_household_employer message by calling internal and processing.
 * \param household_id Message variable.
 * \param employer_id Message variable.
 * \param position Message variable.
 */
...
/** \fn void add_jpoffice_firm_employee_message(int firm_id, int employee_id, int position)
...
/** \fn void add_buy_housing_message(int buyer_id, int bank_id, double liquidity, double quarterly_income, double quarterly_mortgage_paid, int mortgage_choice)
 ...
 * \param mortgage_choice Message variable.
 */
void add_buy_housing_message(int buyer_id, int bank_id, double liquidity, double quarterly_income, double quarterly_mortgage_paid, int mortgage_choice)
{
    ...
    msg.mortgage_choice = mortgage_choice;
